...
export class UserService {
  ...
  getAll() {
    return this.http
      .get<Response>(this.urlApi.concat('/user/get_all'), httpOptions)
      .pipe(
        map(response => {
  ...
  getUsersByRolId(user: UserAffiliate) {
    return this.http
      .get<Response>(
        this.urlApi.concat(
  ...
  getUser(user: UserAffiliate) {
    return this.http
      .get<Response>(
        this.urlApi.concat('/user/get_user?id=', user.id.toString()),
        httpOptions,
      )
      .pipe(
        map(response => {
  ...
  updateUser(user: UserAffiliate) {
    return this.http
      .put<Response>(
        this.urlApi.concat('/user/', user.id.toString()),
        user,
        httpOptions,
      )
      .pipe(
  ...
  deleteUser(id: number) {
    return this.http
      .delete<Response>(
        this.urlApi.concat('/user/', id.toString()),
        httpOptions,
      )
      .pipe(
        map(data => {
  ...
  createUser(user: UserAffiliate) {
    return this.http
      .post<Response>(this.urlApi.concat('/user'), user, httpOptions)
      .pipe(
        map(data => {
          return data;
        }),
